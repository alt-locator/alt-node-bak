...
export interface FirebaseConfig {
  /**
   * The firebase host name. For example this could be: 'foo-baz.firebaseio.com'. The value
   * of the firebaseHost can be overriden by environment variable 'ALT_FIREBASE_HOST'.
   * 
